...
<template>
	<view class="page">
		<!-- 省市区选择器 -->
		<navigator class="row" url="/pages/biaofun-region/biaofun-region">
			<text class="name">省市区选择器</text>
			<text class="iconfont right-icon">&#xe63e;</text>
		</navigator>
		
		<!-- 日期时间选择器 -->
		<navigator class="row" url="/pages/biaofun-datetime-picker/biaofun-datetime-picker">
			<text class="name">日期时间选择器</text>
			<text class="iconfont right-icon">&#xe63e;</text>
		</navigator>
		
		<!-- 瀑布流布局 -->
		<navigator class="row" url="/pages/biaofun-waterfall/biaofun-waterfall">
			<text class="name">瀑布流布局</text>
			<text class="iconfont right-icon">&#xe63e;</text>
		</navigator>
		
		<!-- 滑动列表 -->
		<navigator class="row" url="/pages/biaofun-swiper-list/biaofun-swiper-list">
			<text class="name">滑动列表</text>
			<text class="iconfont right-icon">&#xe63e;</text>
		</navigator>
		
		<!-- 加载更多 -->
		<navigator class="row" url="/pages/biaofun-loading-more/biaofun-loading-more">
			<text class="name">加载更多</text>
			<text class="iconfont right-icon">&#xe63e;</text>
		</navigator>
		
		<!-- 跑马灯 -->
		<navigator class="row" url="/pages/biaofun-marquee/biaofun-marquee">
			<text class="name">跑马灯</text>
			<text class="iconfont right-icon">&#xe63e;</text>
		</navigator>
	</view>
</template>
