	...
	return function(e) {
		...
		var s = function(e) {
			...
			i = function(e) {
				(null == (e = n({}, e)).title || e.title.length < 1) && (e.title = "加载中..."), void 0 === e.mask && (e.mask = !0),
					uni.showNavigationBarLoading(n({}, e))
			},
			a = function() {
		...
		var p = function e(t) {
			var r = t.baseUrl,
				n = t.timeout,
				o = t.headers,
				s = t.showNavigationBarLoading,
				i = t.showError,
				a = t.requestInterceptors,
				u = t.responseInterceptors;
			! function(e, t) {
				if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function")
			}(this, e), e.headers = o, e.showNavigationBarLoading = s, e.showError = i;
			var l = new c.a;
		...
		p.headers = {}, p.showNavigationBarLoading = !0, p.showError = !0, p.requestInterceptors = {
			success: function(e) {
				return console.log("请求"), e.headers = p.headers, 1 == p.showNavigationBarLoading && i(), e
			},
			error: function(e) {
				return a(), p.showError && s({
					title: `请求失败${e.message} ${e.request.url}`
				}), Promise.reject(e)
			}
		}, p.responseInterceptors = {
			success: function(e) {
				return p.showNavigationBarLoading && a(), console.log("响应"), Promise.resolve(e)
			},
			error: function(e) {
				return a(), p.showError && s({
					title: `响应失败${e.message} ${e.request.url}`
				}), Promise.reject(e)
			}
		};
		var d = p;
